< >
    <footer class="footer-section position-relative">
        <img class="footer-bg-shape" src="/images/footer/shape.png" alt="images_notFound" />
        <img class="path-shape" src="/images/footer/path-shape.png" alt="images_notFound" />
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <ul class="address">
                                            ...
                                            <li>
                                                ...
                                                <a href="mailto: andzukor@gmail.com"> andzukor@gmail.com</a>
                                            </li>
                                            <li>
                                                <span class="icon">
