                ...
                <div class="col-lg-8 ps-xl-7">
                    ...
                    <div class="service-details">
                        <div class="service-details-list d-md-flex">
                            <img class="align-self-center me-md-5 mt-4 mt-lg-0" src="/images/blog-details/2.png" alt="images_not_found" />
                            ...
                            <div class="col-md-4 mb-4 col-6 order-1 order-md-0">
                                <div class="service-prev service-media">
                                    <div class="content">
                                        ...
                                        <nuxt-link to="/blog-details" class="link">Previous <i class="icofont-rounded-double-right"></i></nuxt-link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4 col-6 order-2 order-md-0">
                                <div class="service-next service-media">
                                    <div class="content">
                                        ...
                                        <nuxt-link to="/blog-details" class="link">Next <i class="icofont-rounded-double-right"></i></nuxt-link>
                                    </div>
                                </div>
                            </div>
                        </div>
